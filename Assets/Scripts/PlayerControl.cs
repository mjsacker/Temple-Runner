...
public class PlayerControl : MonoBehaviour {
	...
	void Update (){
		if (controller.isGrounded) {
			...
			if (Input.GetButton ("HumanoidJumpUp")) {          //play "Jump" animation if character is grounded and spacebar is pressed
				GetComponent<Animation>().Stop("HumanoidRun");
				GetComponent<Animation>().Play("HumanoidJumpUp");
	...
	{               
		other = GetComponent<Collider> (); //Mark
